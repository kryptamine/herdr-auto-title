...
func TestMeaningful(t *testing.T) {
	tests := []struct {
		...
		{
			"agent hook in front of the work",
			"Running: orca-status - Improve herdr",
			"Improve herdr",
			true,
		},
		{
			"agent thinking line in front of the work",
			"Thinking - Improve herdr screenshot",
			"Improve herdr screenshot",
			true,
		},
		{
			"hook then thinking then the work",
			"Running: orca-status - Thinking - Improve herdr",
			"Improve herdr",
			true,
		},
		{"hook line with nothing after it", "Running: orca-status", "", false},
		{"thinking with nothing after it", "Thinking", "", false},
		{
			"running without a separator is real work",
